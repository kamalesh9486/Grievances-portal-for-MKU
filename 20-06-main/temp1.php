...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <input type="hidden" name="name" value="<?php echo htmlspecialchars($name); ?>">
                ...
                <!-- Hidden input fields -->
                <!-- Make sure to include all hidden fields here -->
                ...
                <textarea class="form-control grievances_details" id="grievances_details" name="grievances_details" rows="10"  required></textarea>
                <!-- Input fields for document upload -->
                <!-- Make sure to include all input fields here with appropriate labels -->
                <!-- Example: -->
                <label for="document1" id="label1"><h2>Fees Payment Details:</h2></label>
                <input type="file" name="document1" id="document1" accept=".pdf, .doc, .docx" class="form-control"><br>
                <!-- Add more input fields as needed -->
                    ...
                    <input type="submit" value="Upload and Save Data" class="btn btn-primary">
            </form>
        </div>
    </div>
    ...
    <!-- Custom jQuery script for showing/hiding labels based on grievance type -->
    <script>
